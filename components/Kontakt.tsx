...
const infoItems = [
  { icon: MapPin, label: "Adresse",        value: "Dorotheenstraße 14\n22301 Hamburg-Winterhude" },
  { icon: Phone,  label: "Telefon",        value: "+49 40 52 34 68 10" },
  { icon: Mail,   label: "E-Mail",         value: "hallo@eclat-studio.de" },
  { icon: Clock,  label: "Öffnungszeiten", value: "Mo–Fr: 09:00–18:30\nSa: 09:00–15:00\nSo: geschlossen" },
]
...
export function Kontakt() {
  ...
  return (
    <section id="kontakt" style={{ background: "#110d0b", padding: "9rem 1.5rem" }}>
            ...
            {success ? (
              <div
                ...
                style={{
                  ...
                  background: "rgba(212,168,160,0.04)",
                }}
              >
                <CheckCircle size={40} style={{ color: "#D4A8A0", marginBottom: "1rem" }} strokeWidth={1.2} />
              ...
              <form onSubmit={handleSubmit} noValidate style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                <div>
                  <input
                    ...
                    onFocus={e => { e.currentTarget.style.borderColor = "rgba(212,168,160,0.5)" }}
                ...
                <div>
                  <textarea
                    ...
                    placeholder="Ihre Nachricht (Behandlung, Wünsche …) *"
                ...
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 500,
                    fontSize: "0.9rem",
                    background: loading ? "rgba(212,168,160,0.5)" : "#D4A8A0",
                    color: "#0c0908",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
              {infoItems.map(item => (
                <div key={item.label} className="flex" style={{ gap: "1.25rem" }}>
                  ...
                  >
                    <item.icon size={15} style={{ color: "#D4A8A0" }} strokeWidth={1.5} />
                  </div>
                  <div>
                    <p
              ...
              <div
                ...
                style={{
                  height: "170px",
                  borderRadius: "1rem",
                  background: "linear-gradient(135deg, #180e0a 0%, #221610 50%, #120a08 100%)",
              ...
              >
                <div className="text-center">
                  <MapPin
                    size={22}
                    style={{ color: "#D4A8A0", margin: "0 auto", marginBottom: "0.5rem" }}
                    strokeWidth={1.5}
                  />
                  <p style={{ fontSize: "0.78rem", color: "rgba(255,255,255,0.35)" }}>
                    Dorotheenstraße 14 · Hamburg-Winterhude
                  </p>
                </div>
              </div>
            </div>
