    ...
    <>
      <nav
        ...
        style={{
          ...
          borderBottom: scrolled ? "1px solid rgba(212,168,160,0.12)" : "1px solid transparent",
        }}
      >
        <div
        ...
        >
          ...
          <button
            ...
            aria-label="ÉCLAT STUDIO – zurück nach oben"
          >
            <EclatLogo size={36} />
            <span
              style={{
          ...
          <div className="flex items-center" style={{ gap: "0.75rem" }}>
            <button
              ...
              onMouseEnter={e => {
                e.currentTarget.style.background = "#D4A8A0"
                e.currentTarget.style.color = "#0c0908"
              }}
              onMouseLeave={e => {
                e.currentTarget.style.background = "transparent"
                e.currentTarget.style.color = "#D4A8A0"
              }}
            >
              Termin buchen
            </button>
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-[100] flex flex-col" style={{ background: "#0c0908" }}>
          <div
            className="flex items-center justify-between"
            style={{ padding: "0 1.5rem", height: "4.5rem", borderBottom: "1px solid rgba(212,168,160,0.12)" }}
          >
